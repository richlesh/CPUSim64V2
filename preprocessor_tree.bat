...
java -cp "%SCRIPT_DIR%lib\*" org.antlr.v4.gui.TestRig cloud.lesh.CPUSim64.Preprocessor preproc "%~1.asm" -tokens -gui
...
:: Get tree output
java -cp "%SCRIPT_DIR%lib\*" org.antlr.v4.gui.TestRig cloud.lesh.CPUSim64.Preprocessor preproc "%~1.asm" -tree > "%TEMP%\tree_output.txt"
