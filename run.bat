...
call "%SCRIPT_DIR%assemble.bat" %1 %2 %3 %4 %5 %6 %7 %8 %9
...
if defined O64_FILE (
    java -Dfile.encoding=UTF8 -cp "%SCRIPT_DIR%lib\*" cloud.lesh.CPUSim64.Simulation "%O64_FILE%" --verbose --mem=%MEMSIZE% --stack=%STACKSIZE% %2 %3 %4 %5 %6 %7 %8 %9
)
