...
public class CPUSim64v2Parser extends Parser {
	...
	public static class POperandContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof CPUSim64v2Listener ) ((CPUSim64v2Listener)listener).enterPOperand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof CPUSim64v2Listener ) ((CPUSim64v2Listener)listener).exitPOperand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof CPUSim64v2Visitor ) return ((CPUSim64v2Visitor<? extends T>)visitor).visitPOperand(this);
			else return visitor.visitChildren(this);
		}
	}
