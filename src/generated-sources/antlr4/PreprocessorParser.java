...
public class PreprocessorParser extends Parser {
	...
	public static final int
		...
		PP_ENDDOWHILE=30, PP_BREAK=31, PP_CONTINUE=32, PP_IFCOND=33, PP_IFCONDSR=34, 
		PP_ELSEIFCOND=35, PP_ELSECOND=36, PP_ENDCOND=37, REG_R=38, REG_F=39, PLACEHOLDER=40, 
		IDENT=41, INT=42, FLOAT=43, CHAR=44, STRING=45, ANGLE_PATH=46, EQEQ=47, 
		NEQ=48, LE=49, GE=50, LT=51, GT=52, COMMA=53, LPAREN=54, RPAREN=55, DOLLAR=56, 
		LCURLY=57, RCURLY=58, ELLIPSIS=59, CODE_TEXT=60, LINE_COMMENT_D=61, WS_D=62;
	public static final int
		...
		RULE_doWhileBlock = 27, RULE_breakDir = 28, RULE_continueDir = 29, RULE_ifCondBlock = 30, 
		RULE_ifCondSRBlock = 31, RULE_elseifCondClause = 32, RULE_elseCondClause = 33, 
		RULE_block = 34, RULE_expr = 35, RULE_primary = 36, RULE_cmpOp = 37, RULE_literal = 38;
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"PP_ENDDOWHILE", "PP_BREAK", "PP_CONTINUE", "PP_IFCOND", "PP_IFCONDSR", 
			"PP_ELSEIFCOND", "PP_ELSECOND", "PP_ENDCOND", "REG_R", "REG_F", "PLACEHOLDER", 
			"IDENT", "INT", "FLOAT", "CHAR", "STRING", "ANGLE_PATH", "EQEQ", "NEQ", 
			"LE", "GE", "LT", "GT", "COMMA", "LPAREN", "RPAREN", "DOLLAR", "LCURLY", 
			"RCURLY", "ELLIPSIS", "CODE_TEXT", "LINE_COMMENT_D", "WS_D"
		};
	}
	...
	public final PreprocContext preproc() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1152923736551189488L) != 0)) {
				{
				setState(80);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final CallDirContext callDir() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 8936555632656384L) != 0)) {
				{
				setState(137);
				argList();
				}
	...
	public final ForBlockContext forBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 68994354642944L) != 0)) {
				{
				setState(306);
