...
gFOUR:		.DCF 4.0
#def_func	compute_escape(x0arg, y0arg)
...
#def_func	combine_output(filename, imageSize)
	#var	i, c, m, fn, size, out_port, image_buffer, pix_value, histogram, max_iteration, subtotal, totalCount, header, codepoints
	load	fn, filename
	load	size, imageSize
	load	image_buffer, IMAGE
	load	max_iteration, gMAX_ITERATION
